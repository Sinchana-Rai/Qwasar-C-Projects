...
In our life as a developer, there is a before and after with pointers :D There is no better way to learn pointers than by doing it.
...
The objective of this quest is to discover pointers and start to get experience with pointers. We will also do some loops. :)
...
Tip (In C) Pointer is a key element here. Remember a pointer is a variable that contains the address of another variable.
...
Return Value: nil
Tip You should use Google to learn about String interpolation :-)
...
Output: 
Return Value: ""
Tips Google upcase string YOURCODINGLANGUAGE (In C)
...
Output: 
Return Value: ""
Tips Google downcase string YOURCODINGLANGUAGE (In C)
